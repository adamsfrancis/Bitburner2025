...
export const serverConstants = {
  ...
  maxPercentageToSpendPerUpgrade: 0.2,
  ramCostGrow: 1.75,
  ramCostHack: 1.7,
  ramCostWeaken: 1.75,
...
export const filesToSCP = [
  ...
  '/managers/scripts/share.js'
]

export const evolvingManFiles:Record<string,string> = {
  scoutingReport:'/managers/evolvingMan/shared/scoutingReport.txt',
  pathfindersReport:'/managers/evolvingMan/shared/pathfindersReport.txt',
  sapperJobs:'/managers/evolvingMan/shared/sapperJobs.txt',
